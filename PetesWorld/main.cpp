...
int main()
{
	...
	if (letter == 'b' || letter == 'B') // written by Ethan
	{
		if (region == 1)
		{
		...
		if (region == 2)
		{
			std::cout << "Belarus, Belgium, Bulgaria, Bosnia and Herzegovina" << std::endl;
		}
		if (region == 3)
		{
	...
	if (letter == 'c' || letter == 'C') // written by Ethan
	{
		if (region == 1)
		{
		...
		if (region == 4)
		{
			std::cout << "China, Christmas Island, Cocos Islands, Cyprus" << std::endl;
		}
	}
